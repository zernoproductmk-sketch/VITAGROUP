  ...
  return <>
    ...
    <section className="card panel">
      ...
      <div className="admin-note">
        Если в задании 1С нет ДЕНЬ/НОЧЬ, заказ создается без выдуманной смены. Производственный запуск будет создан после прихода факта Coverse с фактической сменой.
      </div>
    </section>
  </>;
}
